...
if(T){
  ...
  dim(myNorm) 
  pD=myLoad$pd
  save(myNorm,pD,file = 'step2_GSE36278_champ_myNorm.Rdata')
}
load(file = 'step2_GSE36278_champ_myNorm.Rdata')
...
if(T){
  ...
  ggsave('GSE36278_all_samples_PCA.png')
  ...
  pheatmap(n,show_colnames =F,show_rownames = F,
           annotation_col=ac,filename = 'GSE36278_heatmap_top1000_sd.png')
  dev.off()
  ...
  pheatmap::pheatmap(M,
                     show_rownames = F,
                     annotation_col = colD,
                     filename = 'GSE36278_cor_top500.png')
  dev.off() 
